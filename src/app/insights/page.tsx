...
const fallbackArticles: Article[] = Array.from({ length: 28 }, (_, i) => ({
  ...BASE_ARTICLES[i % BASE_ARTICLES.length],
  _id: String(i + 1),
  slug: `${BASE_ARTICLES[i % BASE_ARTICLES.length].slug}${i >= BASE_ARTICLES.length ? `-${Math.floor(i / BASE_ARTICLES.length) + 1}` : ''}`,
}));
